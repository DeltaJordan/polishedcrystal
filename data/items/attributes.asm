...
; AWAKENING
	item_attribute 100, 0, SLP_MASK, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; ICE HEAL
...
; CARBOS
	item_attribute 10000, 0, MON_SPE_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CALCIUM
...
; CHESTO BERRY
	item_attribute 10, HELD_HEAL_STATUS, SLP_MASK, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; PECHA BERRY
...
; TAMATO BERRY
	item_attribute 10, HELD_NO_BUG_BITE, MON_SPE_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; LIECHI BERRY
...
; EXP.SHARE
	item_attribute 3000, 0, 0, ITEM, ITEMMENU_CLOSE, ITEMMENU_CLOSE
; SILK SCARF
...
; CLEAR AMULET
	item_attribute 4000, HELD_CLEAR_AMULET, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MIRROR HERB
	item_attribute 4000, HELD_MIRROR_HERB, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PUNCHINGLOVE
	item_attribute 4000, HELD_PUNCHING_GLOVE, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; COVERT CLOAK
	item_attribute 4000, HELD_COVERT_CLOAK, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LOADED DICE
	item_attribute 4000, HELD_LOADED_DICE, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LIGHT BALL
	item_attribute 1000, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LEEK
...
; POWER ANKLET
	item_attribute 3000, HELD_EV_SPE_UP, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DRAGON SCALE
	item_attribute 2000, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; UP-GRADE
	item_attribute 2000, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; OVAL STONE
	item_attribute 2000, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ODD SOUVENIR
	item_attribute 3000, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; LINKING CORD
	item_attribute 3000, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
